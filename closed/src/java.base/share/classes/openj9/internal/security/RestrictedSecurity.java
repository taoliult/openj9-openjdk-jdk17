...
public final class RestrictedSecurity {
    ...
    /**
     * Check if the FIPS mode set is 140-2.
     *
     * Older profiles are set in FIPS 140-2 mode. This method responds on
     * whether the loaded profile is one of those.
     *
     * @return true if the FIPS mode set is 140-2
     */
    public static boolean isFIPS1402() {
        if (securityEnabled) {
            return "140-2".equals(restricts.jdkFipsMode);
        }
        return false;
    }
    ...
    private static final class RestrictedSecurityProperties {
        ...
        private RestrictedSecurityProperties(String profileID, String descName,
                                             boolean descIsDefault, boolean descIsFIPS,
                                             String descNumber, String descPolicy,
                                             String descSunsetDate,
                                             String jdkTlsDisabledNamedCurves,
                                             String jdkTlsDisabledAlgorithms,
                                             String jdkTlsEphemeralDHKeySize,
                                             String jdkTlsLegacyAlgorithms,
                                             String jdkCertpathDisabledAlgorithms,
                                             String jdkSecurityLegacyAlgorithms,
                                             String keyStoreType,
                                             String keyStore,
                                             String jdkSecureRandomProvider,
                                             String jdkSecureRandomAlgorithm,
            ...
            this.descIsDefault = descIsDefault;
            this.descIsFIPS = descIsFIPS;
            this.descNumber = descNumber;
            this.descPolicy = descPolicy;
            this.descSunsetDate = descSunsetDate;

            // Security properties.
            this.jdkTlsDisabledNamedCurves = jdkTlsDisabledNamedCurves;
            this.jdkTlsDisabledAlgorithms = jdkTlsDisabledAlgorithms;
            this.jdkTlsEphemeralDHKeySize = jdkTlsEphemeralDHKeySize;
            this.jdkTlsLegacyAlgorithms = jdkTlsLegacyAlgorithms;
            this.jdkCertpathDisabledAlgorithms = jdkCertpathDisabledAlgorithms;
            this.jdkSecurityLegacyAlgorithms = jdkSecurityLegacyAlgorithms;
            this.keyStoreType = keyStoreType;
            this.keyStore = keyStore;

            // For SecureRandom.
            this.jdkSecureRandomProvider = jdkSecureRandomProvider;
            this.jdkSecureRandomAlgorithm = jdkSecureRandomAlgorithm;

            this.jdkFipsMode = jdkFipsMode;
    ...
    private static final class ProfileParser {
        ...
        private Map<String, String> profilesHashes;
        private Map<String, List<String>> profilesInfo;
        ...
        private RestrictedSecurityProperties getProperties() {
            RestrictedSecurityProperties rsProperties = new RestrictedSecurityProperties(
                this.profileID,
                getProperty("descName"),
                this.descIsDefault,
                this.descIsFIPS,
                getProperty("descNumber"),
                getProperty("descPolicy"),
                getProperty("descSunsetDate"),
                getProperty("jdkTlsDisabledNamedCurves"),
                getProperty("jdkTlsDisabledAlgorithms"),
                getProperty("jdkTlsEphemeralDHKeySize"),
                getProperty("jdkTlsLegacyAlgorithms"),
                getProperty("jdkCertpathDisabledAlgorithms"),
                getProperty("jdkSecurityLegacyAlgorithms"),
                getProperty("keyStoreType"),
                getProperty("keyStore"),
                getProperty("jdkSecureRandomProvider"),
                getProperty("jdkSecureRandomAlgorithm"),
                getProperty("jdkFipsMode")
            );

            rsProperties.providers.addAll(this.providers);
            rsProperties.providersSimpleName.addAll(this.providersSimpleName);
            rsProperties.providerConstraints.putAll(this.providerConstraints.entrySet()
                                                                            .stream()
        ...
        private void init(String profileID) {
            ...
            if (potentialExtendsProfileID != null) { // If profile extends another profile.
                ...
                try {
                    ...
                    } else if (!"140-2".equals(getProperty("jdkFipsMode"))) {
        ...
        private void checkHashValues() {
            for (Map.Entry<String, String> entry : profilesHashes.entrySet()) {
                ...
                try {
                    ...
                    byte[] allInfoArray = allInfo.stream().sorted().collect(Collectors.joining("\n")).getBytes();
                    ...
                    if (!resultHashHex.equals(expectedHash)) {
        ...
        private static void checkProviderFormat(String providerInfo, boolean update) {
            Pattern p = Pattern.compile(
    "^([A-Za-z0-9\\-\\.]+)\\s*(\\s[A-Za-z0-9\\$\\{\\}\\./]+)?\\s*(\\s\\[\\s*([\\+\\-])?\\s*([A-Za-z0-9\\{\\}\\-\\.\\=\\*\\|:,/\\s]+)\\])?\\s*$");
            Matcher m = p.matcher(providerInfo);
            if (m.find()) {
